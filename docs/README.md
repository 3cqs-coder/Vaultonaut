...
vdisk serve    <name|path>       Serve a vault as a node another machine can mirror to (encrypted only). --lan serves it directly on your local network, discovered automatically (no setup)
