...
vdisk notes-import <file> <vault> Import logins and notes from a .csv or a Bitwarden .json export into an open vault (--dry-run, --skip-duplicates, --format csv|bitwarden|auto)
