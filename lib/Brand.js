...
// A few spots also carry the name/cli/ext for fallback or substitution, NOT as an independent source of truth:
// the web client's data-* fallbacks in public/js/app.js, the CLI help placeholders in lib/Commands.js that are
// substituted with these Brand values at print time, and the Recovery Kit template defaults in lib/RecoveryKit.js
// (used only when a caller passes no brand data). Update those alongside a rename if they drift.)
