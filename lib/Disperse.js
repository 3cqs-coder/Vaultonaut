...
function decodeShards(shardBuffers) {
	...
	if (!parsed.length) throw new Error('No readable shards were provided.');
...
module.exports = { encodeShards, decodeShards, dominantGroup, shardInfo, readShard, shardIdxFromName, MAGIC, HEADER, MAX_ARCHIVE_BYTES };
