...
async function healCore({ vaultDir, cipherDir, expectIndexHash, force, preserveInPlaceEdits }, onProgress) {
	...
	if (onProgress) onProgress({ percent: 100, label: 'Done' });
	return { protected: true, repairedData, repairedParity, repairedSize, writeErrors, unrecoverableStripes, healed: repairedData + repairedParity + repairedSize, repairedFiles: [...repairedFiles], changedSkipped: editedFiles.size, inPlaceDeferred: inPlaceSkipped.size, inPlaceDeferredFiles: [...inPlaceSkipped], indexHash: index.indexHash, version: index.version };
}
