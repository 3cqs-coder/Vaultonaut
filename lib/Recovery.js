...
async function protect(vaultDir, { tier, cipherDir, thorough, exclude, signPriv, vaultId, manifestFloor = 0, maxDataBlocks, onProgress } = {}) {
...
async function heal(vaultDir, { cipherDir, pubkey, vaultId, expectedFloor = 0, allowUnverified, force, preserveInPlaceEdits, onProgress } = {}) {
	const abs = path.resolve(vaultDir);
	return serialize(abs, async () => {
