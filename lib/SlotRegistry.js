...
module.exports = { newKdfParams, deriveK, encryptSlot, tryDecryptSlot, findSlot, randomSlot, shuffle, store, isSupportedRecord, PLAINTEXT_SIZE, SLOT_LEN, SUPPORTED_V };
