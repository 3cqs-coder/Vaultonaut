'use strict';
// lib/test/mobile-reader.js — proves the portable, browser-ready decryptor (public/mobile/rclone-reader.js)
...
async function main() {
	...
	const reader = require('../webserver/public/mobile/rclone-reader.js');
