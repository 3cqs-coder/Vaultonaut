...
async function main() {
	...
	try {
		...
		// FORWARD-REFUSE: a record written by a newer format is not edited here (so its extra data is never dropped).
		...
		ok('a newer-format item is refused rather than overwritten', refusedNewer);
