...
// (Launcher, RcloneSetup, Shortcut, Autostart), build scripts, worker threads / forked children (SearchDefs, Extract,
...
// HMAC-based hkdf on Vault, and dir hardening plus a one-time, memoized PATH probe for the desktop file/URL opener on
// Common (both off the shared-service hot path — the opener probe runs only when a user opens a page or reveals a
// folder, and caches its result for the process).
const CEILING = {
	'Commands.js': 14, 'Launcher.js': 12, 'scripts/sign-release.js': 10, 'Emergency.js': 8, 'Net.js': 7,
	'verify-bundle.js': 5, 'Driver.js': 5, 'SlotRegistry.js': 4, 'Common.js': 4, 'webserver/mobileRoutes.js': 3, 'Vault.js': 3,
	'RcloneSetup.js': 3, 'Timelock.js': 2, 'SearchDefs.js': 2, 'Phase.js': 2, 'Integrity.js': 2,
