...
function main() {
	...
	const required = ['vaultonaut.js', 'verify.js', 'release-manifest.json', 'release-manifest.sig', 'release-manifest.sig.pq', 'docs/README.md', 'LICENSE', 'CONTRIBUTING.md', 'lib/index.js', 'lib/Vault.js', 'lib/templates/help.txt'];
