...
// vault to an opaque folder on unlock would rename them out from under the test. Opt every test out by default; the
// one test that exercises auto-conversion clears this flag for its own case.
