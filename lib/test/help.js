...
function main() {
	...
	ok('the guide file docs/README.md exists, is the real Vaultonaut README (banner header + intro), and is substantial', /src="banner\.(png|svg)"/.test(md) && /Vaultonaut creates portable/.test(md) && md.length > 5000);
