...
async function done() {
	...
	ok('the web travel-start endpoint stops serve, mobile, and lease sessions before hiding', /travel-start'[\s\S]{0,160}stopAllLeaseHeartbeats\(\)[\s\S]{0,60}Mobile\.stopAll\(\)[\s\S]{0,60}stopAllServing\(\)[\s\S]{0,60}travelEnable/.test(server));
