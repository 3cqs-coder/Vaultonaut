...
function main() {
	...
	ok('the Linux first-paint navigation targets the http splash', /fn nudge_repaint[\s\S]{0,1400}http:\/\/127\.0\.0\.1:\{\}\//.test(mainRs) && /nudge_repaint\(app\.handle\(\)\)/.test(mainRs));
