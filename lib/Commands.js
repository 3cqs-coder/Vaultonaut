...
const BOOLEAN_FLAGS = new Set([
	...
	'dry-run', 'skip-duplicates', 'json', 'lan', 'wan', 'onion', 'single-hop', 'opaque', 'anonymize',
]);
...
async function cmdServe(pos, flags) {
	...
	const h = await vdisk.serveVault(target, { bind: (relay || lan || wan || onion) ? undefined : flags.bind, lan, wan, onion, singleHop, port: parsePort(flags.port, undefined), readOnly: !!flags['read-only'], onEvent, relay });
