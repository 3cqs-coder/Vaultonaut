...
function signHybrid(edPriv, pqPriv, payload) { return { sig: sign(edPriv, payload), sigPq: signPq(pqPriv, payload) }; }
...
function signKeysFromSeed(seedB64) {
	...
	return { priv, pub: spki.subarray(spki.length - 32).toString('hex'), get pqPriv() { return lazy().priv; }, get pqPub() { return lazy().pub; } };
}
