...
// baseline and the manifest seal check the pair identically.
function verifyHybrid(edPub, pqPub, payload, sig, sigPq) { return verify(edPub, payload, sig) && verifyPq(pqPub, payload, sigPq); }
