...
module.exports = { verifyBundle, verifyFileProof, _primitives: { merkleRoot, verifyMerkleProof, fileLeafHex, identity, fingerprint, signingInput, levelOf, sealTag, keySlotsOf }, _sealParity: { verify, manifestSealInput, manifestSealVerifies, rosterSealInput, rosterVerifies, rosterSealNewer, successionInput, attestGenesis, attestChainHash, attestDigest, tokenHashOf }, _bundleVersions: { BASELINE_VERSION, SEAL_VERSION, ROSTER_SEAL_VERSION, ATTEST_VERSION, SUCCESSION_VERSION, GENESIS_VERSION, FILE_PROOF_VERSION, SCHEME } };
