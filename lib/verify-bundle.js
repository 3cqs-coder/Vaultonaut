...
module.exports = { verifyBundle, _primitives: { merkleRoot, identity, fingerprint, signingInput, levelOf, sealTag, keySlotsOf }, _sealParity: { verify, manifestSealInput, manifestSealVerifies, rosterSealInput, rosterVerifies, successionInput, attestGenesis, attestChainHash, attestDigest, tokenHashOf }, _bundleVersions: { BASELINE_VERSION, SEAL_VERSION, ATTEST_VERSION, SUCCESSION_VERSION, GENESIS_VERSION, SCHEME } };
