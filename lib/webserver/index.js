...
function updateStatusFrom(last) {
	...
	return { current, latest: last.latest, at: last.at || null, updateAvailable: UpdateCheck.compareVersions(last.latest, current) > 0, releasesUrl: UpdateCheck.RELEASES_URL };
}
