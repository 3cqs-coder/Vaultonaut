...
async function buildState() {
	...
	return { doctor, vaults, mounts, settings: publicSettings(settings), sftpDests, cloudRemotes, peers, auth: { enabled: uiAuth.enabled }, selfCheck: SelfCheck.last(), disk: SelfCheck.diskSnapshot(), vaultsDir: Vault.vaultsDir(), defaultRoot: Vault.defaultMountRoot(), home: os.homedir() };
}
