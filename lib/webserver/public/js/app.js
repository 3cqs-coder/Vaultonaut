	...
	if ($('#notesImportBtn') && $('#notesImportFile')) {
		...
		$('#notesImportFile').addEventListener('change', async (ev) => {
			...
			try {
				...
				notesShow('good', 'Imported ' + r.imported + ' item' + (r.imported === 1 ? '' : 's') + (r.skipped ? ', skipped ' + r.skipped + ' already present' : '') + '. Your export file still holds these secrets in the clear — delete it now.');
