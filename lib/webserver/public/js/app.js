...
function serveBindChanged() { $('#serveRelayRow').hidden = $('#serveBind').value !== 'relay'; const onion = $('#serveBind').value === 'onion'; if ($('#serveSingleHopRow')) $('#serveSingleHopRow').hidden = !onion; if ($('#serveStableRow')) $('#serveStableRow').hidden = !onion; }
