...
var SHELL = ['./', 'index.html', 'theme-boot.js', 'app.css', 'app.js', 'crypt-reader.js', 'shared/secret-schema.js', 'vendor/nacl.min.js', 'vendor/scrypt.js', 'vendor/aes-js.js', 'icon.svg', 'manifest.webmanifest', 'config'];
