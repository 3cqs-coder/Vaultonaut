...
module.exports = {
	root, appScriptPath, setDesktopApp, isDesktopApp, isSupervisedChild, supervisedChildEnv, SUPERVISED_ENV, dataDir, setDataDir, dataDirOverridePath, ensureDataDir, binDir, setBinDir, binDirIsPreinstalled, vaultsDir, runDir, statePath, samePath, sameFile, pathWithin, resolveThroughSymlinks, pathExistsBounded, isLoopbackHost, redactPaths, unixOpener, openerCommand, sanitizeBwlimit, validateBwlimit, foldPath,
