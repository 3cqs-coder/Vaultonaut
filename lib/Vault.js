...
async function verifyBundle(bundleDir, { expectIdentity } = {}) {
	...
	let rosterOk = true;
	if (manifest.members && manifest.members.ownerPubKey && manifest.members.sig) rosterOk = verifyRoster(manifest);
	...
	if (sigOk && ((typeof baseline.version === 'number' && baseline.version > BASELINE_VERSION) || (baseline.scheme && baseline.scheme !== Integrity.SCHEME))) {
...
module.exports._sealParity = { manifestSealInput, manifestSealVerifies, rosterSealInput, verifyRoster, successionInput, attestGenesis, attestChainHash, attestDigest, tokenHashOf };
...
module.exports._bundleVersions = { BASELINE_VERSION, SEAL_VERSION, ATTEST_VERSION, SUCCESSION_VERSION, GENESIS_VERSION, FILE_PROOF_VERSION, SCHEME: Integrity.SCHEME };
