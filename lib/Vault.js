...
async function autoLockTick(mounts, idleMs) {
	...
	for (const p of probes) {
		...
		try {
			const r = await unmount(m.mountpoint, { gentle: true, autoLock: true }); // autoLock: on Windows this must NEVER force-kill an idle-but-open vault (data loss); leave it mounted instead, like macOS/Linux
