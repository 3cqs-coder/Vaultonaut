...
async function serveVault(vaultDir, { bind, port, readOnly, onLine, onEvent, relay } = {}) {
	...
	const registration = Relay.registerNode({ hubHost: relay.host, hubPort: clampInt(relay.port, 1, 65535, Common.DEFAULT_RELAY_PORT), token: relay.token, nodeId: nid, localPort: served.port, onEvent });
	try {
