...
async function unmountImpl(opts, entry, mountpoint) {
	...
	return { ok: !stillMounted, mountpoint, vault: entry && entry.vault ? path.resolve(entry.vault) : null, forced: !!opts.force, stuck: !!(opts.recover && stillMounted), recovered: !!(lastResortRan && !stillMounted) };
}
