...
async function create(vaultDir, { password, level, cloud, worm } = {}) {
	...
	const wormCfg = worm ? { mode: String(worm.mode).toLowerCase() === 'compliance' ? 'compliance' : 'governance', retainDays: clampInt(worm.retainDays, 1, 36500, 1) } : null; // cap at ~100 years
