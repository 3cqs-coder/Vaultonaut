...
async function contentReindex(vaultDir, { onProgress } = {}) {
	...
	try {
		...
		return await WorkerRun.runWorker(path.join(__dirname, 'SearchWorker.js'), { op: 'index', args: { mountpoint } }, onProgress, { idleMs: 180000, idleMessage: 'Indexing the vault', resourceLimits: { maxOldGenerationSizeMb: 2560 } });
