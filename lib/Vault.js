...
// note can never be written that those capped reads would later reject or silently hide. The web route already caps
// its whole request body, so this only bites a future or alternate writer — a defensive, explicit limit.
