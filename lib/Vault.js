...
const VAULT_PATH_KEYED = ['mountPrefs', 'backupDests', 'backupSchedules', 'scrubSchedules', 'syncDests', 'syncLast', 'favorites', 'serveCreds', 'serveNodeIds', 'serveNodeAuth'];
