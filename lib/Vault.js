...
async function reveal(target) {
	...
	try { await Rclone.exec(opener, [target]); return { ok: true }; }
	catch (_) { return { ok: false, error: 'No file manager is available to open ' + target }; }
}
...
module.exports = {
	...
	readManifest, readManifestForPoll, checkManifestSeal, updateManifestFields, displayName, defaultMountRoot, resolveVaultDir, assertReadable, checkOnMount, isIgnoredVaultPath,
