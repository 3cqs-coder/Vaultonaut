...
// hunting down downloads. The installer is downloaded from the driver project's
// official GitHub release and CHECKSUM-VERIFIED (using the same shared Net helper as
// the engine downloader) before it is launched.
//
